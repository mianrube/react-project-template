# AGENT_2.md - Authoritative Project Reconstruction Guide

This document is the authoritative AI-oriented specification for this repository.

It is based on the current `AGENT.md`, but corrected and expanded after reading the actual project structure and implementation.
...
- provide the FAQ creation and update workflows
- demonstrate Formik plus Yup usage with shared MUI plus Formik helpers
- serve as the base FAQ management feature
...
- feature-local form schema, values model, and local mock inventory
...
- assume the old `AGENT.md` is fully accurate without checking the repository
